...
interface NavbarVendeurProps {
  ouvert: boolean;
  basculerMenu: () => void;
}

/**
 * Barre de navigation supérieure pour mobile et tablette — espace vendeur.
 * Contient le logo et le bouton hamburger pour ouvrir/fermer le menu.
 */
export default function NavbarVendeur({ ouvert, basculerMenu }: NavbarVendeurProps) {
  return (
