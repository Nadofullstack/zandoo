...
function FeatureCard({ icon: Icon, title, desc }: FeatureItem) {
  return (
    <div className="bg-white/5 backdrop-blur-md p-3.5 rounded-xl border border-white/10 text-left">
      <Icon size={20} className="text-accent mb-1.5" aria-hidden="true" />
...
export default function BrandPanel() {
  return (
    <section
      aria-hidden="true"
      className="hidden lg:flex w-[50%] shrink-0 relative bg-primary items-center justify-center p-5 overflow-hidden"
    >
      {/* Decorative blobs */}
      <div className="absolute -top-20 -left-20 w-80 h-80 rounded-full bg-accent/20 blur-3xl pointer-events-none" />
      <div className="absolute -bottom-20 -right-20 w-96 h-96 rounded-full bg-accent/10 blur-3xl pointer-events-none" />
      ...
      <div className="relative z-10 text-center max-w-sm">
        ...
        <div className="mb-7">
          ...
          <h1 className="text-2xl font-extrabold text-white mb-3 leading-tight">
            Rejoignez le marché
            <br />
            <span className="text-accent">nouvelle génération.</span>
          </h1>
