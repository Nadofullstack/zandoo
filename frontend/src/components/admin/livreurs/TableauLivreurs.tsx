...
/**
 * Tableau des livreurs avec actions : voir profil, activer, suspendre,
 * supprimer et renvoyer l'invitation.
 */
      ...
      <div className="overflow-x-auto rounded-xl border border-gray-200">
        <table className="w-full text-sm" aria-label="Liste des livreurs">
          <thead className="bg-gray-50 border-b border-gray-200">
            <tr>
              {['Livreur', 'Contact', 'Véhicule', 'Ville', 'Profil', 'Statut', 'Inscription', 'Actions'].map((h) => (
                <th
                  key={h}
                    ...
                    <div className="flex items-center gap-1">
                      {enCours ? (
                        ...
                        <>
                          ...
                          {/* Renvoyer invitation (si profil incomplet) */}
                          {!l.profilComplete && (
                            <button
                              onClick={() => ouvrir('renvoi', l)}
